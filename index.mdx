...
description: Deep AI research, causal analysis, and trading signals for Kalshi and Polymarket.
---
...
<CardGroup cols={3}>
  <Card title="Trading Agents" icon="robot">
    Autonomous agents that screen markets, generate signals, and execute trades via Kalshi or Polymarket.
  </Card>
...
<Steps>
  <Step title="List markets">
    Browse active prediction markets on Kalshi and Polymarket with live pricing and volume data.
  </Step>
